...
# The fetch_wikipedia_info tool we just implemented allows our server to search Wikipedia for any topic and return structured data about the most relevant article. 
